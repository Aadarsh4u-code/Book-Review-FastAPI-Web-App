...
from src.worker.email_tasks import create_email_message, fastmail

celery_app = Celery()

celery_app.config_from_object('src.core.config')
...
# celery -A src.worker.celery_app_tasks.celery_app worker